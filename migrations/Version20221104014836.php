 ...
 */
final class Version20221104014836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer ADD company_id INT DEFAULT NULL, ADD offer_skill LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', DROP company_name_id, DROP offer_skills');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer ADD company_name_id INT NOT NULL, ADD offer_skills VARCHAR(255) NOT NULL, DROP company_id, DROP offer_skill');
